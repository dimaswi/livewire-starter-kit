...
<div class="py-4 text-gray-500 dark:text-gray-400">
    ...
    <ul>
        <li class="relative px-6 py-3  text-gray-800 dark:text-gray-100">
            <button
            ...
            <template x-if="isPagesMenuOpen">
                <ul x-transition:enter="transition-all ease-in-out duration-300"
                    ...
                    <li class="px-2 py-1 transition-colors duration-150 @if (request()->
                        routeIs('admin_users')) text-gray-800 dark:text-gray-100 @endif
                        hover:text-gray-800 dark:hover:text-gray-200">
                        <a class="w-full"
                            href="{{ route('admin_users') }}">{{ __('messages.clients') }}</a>
                    </li>
                </ul>
            </template>
    </ul>
