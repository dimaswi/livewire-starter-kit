                            ...
                            <div
                                ...
                                <div x-cloak x-show="modelOpen"
                                    ...
                                    <div class="flex items-center justify-between space-x-4">
                                        ...
                                        <h1 class="text-xl font-medium text-gray-800 ">Tambah Permission Baru</h1>
                                    ...
                                    <p class="mt-2 text-sm text-gray-500 ">
                                        Anda dapat menambahkan permission baru dimodal ini.
                                    </p>
                                    ...
                                    <form class="mt-5" wire:submit.prevent="save">
                                        <div>
                                            <label for="user name"
                                                ...
                                                Permission <span class="text-red-500">*</span></label>
                ...
                <div x-data="{ showModal: false }">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                                <tr>
                                    <th scope="col" class="px-4 py-3"><center>Nama Permission</center></th>
                            ...
                            <tbody>
                                @foreach ($permission as $key => $value)
                                    <tr class="border-b dark:border-gray-700">
                                        <td class="px-4 py-3"><center>{{ $value->name }}</center></td>
                                        <td class="px-4 py-3">
                                            <center>
                    ...
                    <div
                        ...
                        <div x-cloak x-show="showModal"
                            ...
                            <p class="mt-2 text-sm text-gray-500 ">
                                Anda dapat mengupdate permission dimodal ini.
                            </p>
